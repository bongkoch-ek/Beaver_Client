      ...
      <div className="flex flex-col mx-auto gap-[40px] p-8 w-[95%]">
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          <p className="text-[14px] text-black">
            Created by:{" "}
            <span className="text-[#767676]">{project.user?.fullname}</span>
          </p>
          <p className="text-[14px] text-black">
            Created Date:{" "}
        ...
        <div className="flex justify-center gap-9  h-[50px] mt-[80px]">
          <button className="w-[360px] bg-[#ffe066] rounded-2xl border-4 border-[#ffea98] text-[#333333] text-[18px] font-semibold">
            Task
          </button>
          <button className="w-[360px] bg-[#ffe066] rounded-2xl border-4 border-[#ffea98] text-[#333333] text-[18px] font-semibold">
            Dashboard
