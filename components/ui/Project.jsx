        ...
        <div className="flex flex-col w-full gap-1 border rounded-3xl ">
          {projects.map((project, index) => (
            ...
            <div className='flex flex-col text-[16px] justify-center gap-[16px] pl-[40px] pt=[px]'>
              ...
              <p className='text-[14px]'>Status : <span className='text-[#767676]'> {project.status}</span></p>
              <p className='text-[14px]'>Due Date : <span className='text-[#767676]'> {project.dueDate}</span></p>
                </div>      
            </div> 
              ...
              <div className="flex items-center pr-[40px] ">
                <button
                  className="px-4 py-2 bg-[#FFE006] text-[#333333] rounded-md"
                  >
                  Go to Project 
                </button>
              </div>
            ...
            {
                (index+1 ) !== projects.length && <hr className='border mx-[65px]'/>
            }
